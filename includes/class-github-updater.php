...
/**
 * Class Advanced_PDF_Embedder_GitHub_Updater
 *
...
class Advanced_PDF_Embedder_GitHub_Updater
{
     ...
     * @var string
     */
    private const GITHUB_REPO = 'advanced-pdf-embedder';
     ...
     * @var string
     */
    private const PLUGIN_FILE = 'advanced-pdf-embedder/advanced-pdf-embedder.php';
     ...
     * @var string
     */
    private const PLUGIN_SLUG = 'advanced-pdf-embedder';
     ...
     * @var string
     */
    private const PLUGIN_NAME = 'Advanced PDF Embedder';
     ...
     * @var string
     */
    private const PLUGIN_DESCRIPTION = 'Embed PDF viewer in WordPress using EmbedPDF 2.0.0+.';
     ...
     * @var string
     */
    private const TEXT_DOMAIN = 'advanced-pdf-embedder';
     ...
     * @var string
     */
    private const CACHE_KEY = 'advanced_pdf_embedder_github_release';
    ...
    public static function check_for_update($update, array $plugin_data, string $plugin_file, $locales)
    {
        ...
        // compatibility with WordPress core update screens.
        return array(
    ...
    public static function plugin_info($res, $action, $args)
    {
        ...
        // Always return a valid object so WordPress does not fall back to the
        // WordPress.org API for this GitHub-hosted plugin.
        $res               = new stdClass();
        ...
        // Only add tabs whose content is non-empty so empty tabs stay hidden.
...
// Initialize the updater
Advanced_PDF_Embedder_GitHub_Updater::init();
